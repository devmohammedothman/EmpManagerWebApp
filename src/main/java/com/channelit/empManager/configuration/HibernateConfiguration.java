...
@ComponentScan ({"com.channelit.empManager.configuration"})
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory()
	{
		...
		sessionFactory.setPackagesToScan(new String[] {"com.channelit.empManager.model"});
